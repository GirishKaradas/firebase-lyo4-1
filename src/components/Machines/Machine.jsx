      ...
      >
       <CardContent >               
        ...
        <div>
            ...
            <Button component={NavLink} style={{background: '#0C03EB'}} to={`/machine-data/${data.id}/Module`} className="px-3 py-1 text-xs text-white uppercase  rounded-full dark:bg-indigo-300 dark:text-indigo-900">Open </Button>
        </div>
